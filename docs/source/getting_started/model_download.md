...
This guide provides instructions for downloading the MiniCPM-o 4.5 model from Hugging Face Hub and ModelScope.

## Available Model

**MiniCPM-o 4.5**: Omni model for image and video processing (~18GB)

## Hugging Face Hub Download

Hugging Face Hub is the primary platform for accessing MiniCPM-o 4.5, offering excellent global accessibility and integration with the transformers library.
...
huggingface-cli download openbmb/MiniCPM-o-4_5 --local-dir ./MiniCPM-o-4_5

# Download with resume capability
huggingface-cli download openbmb/MiniCPM-o-4_5 --local-dir ./MiniCPM-o-4_5 --resume-download
```
...
model_dir = snapshot_download('openbmb/MiniCPM-o-4_5', cache_dir='./models')
...
git clone https://www.modelscope.cn/openbmb/MiniCPM-o-4_5.git

# Or with specific depth for faster clone
git clone --depth 1 https://www.modelscope.cn/openbmb/MiniCPM-o-4_5.git
```
...
# Download using CLI
modelscope download --model openbmb/MiniCPM-o-4_5 --local_dir ./MiniCPM-o-4_5
```
...
model_path = "./MiniCPM-o-4_5"  # or your download path
