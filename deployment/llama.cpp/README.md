...
To use llama.cpp means that you use the llama.cpp library in your own program, like writing the source code of [Ollama](https://ollama.com/), [GPT4ALL](https://gpt4all.io/), [llamafile](https://github.com/Mozilla-Ocho/llamafile) etc. But that's not what this guide is intended or could do. Instead, here we introduce how to use the `llama-cli` example program, in the hope that you know that llama.cpp does support MiniCPM-o and how the ecosystem of llama.cpp generally works.
...
1. Get the programs
2. Get the MiniCPM-o models in GGUF[^1] format
3. Run the program with the model

## Deployment Guide

- MiniCPM-o 4.5: [English](./minicpm-o4_5_llamacpp.md) | [中文](./minicpm-o4_5_llamacpp_zh.md)
